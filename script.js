document.addEventListener('keydown', (event) => {
    ...
    if (key == 74) {
    	var audio = new Audio("a3-8.wav");
    	audio.currentTime = 0;
    	audio.play();
        document.getElementById('74').style.backgroundColor = "black";
    ...
    if (key == 75) {
    	var audio = new Audio("b2.wav");
    	audio.currentTime = 0;
    	audio.play();
        document.getElementById('75').style.backgroundColor = "black";
        document.getElementById('75').style.boxShadow = "0px 0px 20px 0px black"
        setTimeout(function () {
    ...
    if (key == 76) {
    	var audio = new Audio("c6.wav");
    	audio.currentTime = 0;
    	audio.play();
        document.getElementById('76').style.backgroundColor = "black";
        document.getElementById('76').style.boxShadow = "0px 0px 20px 0px black"
        setTimeout(function () {
